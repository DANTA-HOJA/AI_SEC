...
# -----------------------------------------------------------------------------------
log = init_logger("Updata 'Zebrafish_DB.xlsx'")
predictions_dir_root = Path(r"/home/rime97410000/ZebraFish_DB/{Model}_Prediction")
db_name = "ZebraFish_DB"
...
zebrafish_db = None
zebrafish_db_path = predictions_dir_root.joinpath(f"{db_name}.xlsx")
