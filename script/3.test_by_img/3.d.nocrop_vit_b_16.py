...
from modules.dl.tester.imagetester.vitb16nocropimagetester import VitB16NoCropImageTester
...
vit_b_16_nocrop_image_tester = VitB16NoCropImageTester()
...
if args.batch_mode == True:
    ...
    for config_path in config_paths:
        vit_b_16_nocrop_image_tester.run(config_path)

else: vit_b_16_nocrop_image_tester.run("3.test_by_image.toml")