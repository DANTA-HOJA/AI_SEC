...
from modules.dl.tester.fishtester.vitb16nocropfishtester import VitB16NoCropFishTester
...
vit_b_16_nocrop_fish_tester = VitB16NoCropFishTester()
...
if args.batch_mode == True:
    ...
    for config_path in config_paths:
        vit_b_16_nocrop_fish_tester.run(config_path)

else: vit_b_16_nocrop_fish_tester.run("4.test_by_fish.toml")