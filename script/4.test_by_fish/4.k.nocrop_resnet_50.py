...
from modules.dl.tester.fishtester import ResNet50NoCropFishTester
...
if args.batch_mode == True:
    ...
    for config_path in config_paths:
        resnet50_nocrop_fish_tester.run(config_path)

else: resnet50_nocrop_fish_tester.run("4.test_by_fish.toml")