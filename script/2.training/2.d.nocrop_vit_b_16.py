...
from modules.dl.trainer.vitb16nocroptrainer import VitB16NoCropTrainer
...
vit_b_16_nocrop_trainer = VitB16NoCropTrainer()
...
if args.batch_mode == True:
    ...
    for config_path in config_paths:
        vit_b_16_nocrop_trainer.run(config_path)

else: vit_b_16_nocrop_trainer.run("2.training.toml")