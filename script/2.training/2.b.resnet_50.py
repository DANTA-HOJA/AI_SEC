...
from modules.dl.trainer.resnet50trainer import ResNet50Trainer
...
resnet50_trainer = ResNet50Trainer()
...
if args.batch_mode == True:
    ...
    for config_path in config_paths:
        resnet50_trainer.run(config_path)

else: resnet50_trainer.run("2.training.toml")