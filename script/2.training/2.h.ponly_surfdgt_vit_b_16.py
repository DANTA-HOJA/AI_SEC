...
from modules.dl.trainer.vitb16ponlysurfdgttrainer import VitB16POnlySurfDGTTrainer
...
vit_b_16_ponly_surfdgt_trainer = VitB16POnlySurfDGTTrainer()
...
if args.batch_mode == True:
    ...
    for config_path in config_paths:
        vit_b_16_ponly_surfdgt_trainer.run(config_path)

else: vit_b_16_ponly_surfdgt_trainer.run("2.training.toml")