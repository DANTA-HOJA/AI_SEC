...
from modules.dl.trainer.vitb16surfdgttrainer import VitB16SurfDGTTrainer
...
vit_b_16_surfdgt_trainer = VitB16SurfDGTTrainer()
...
if args.batch_mode == True:
    ...
    for config_path in config_paths:
        vit_b_16_surfdgt_trainer.run(config_path)

else: vit_b_16_surfdgt_trainer.run("2.training.toml")