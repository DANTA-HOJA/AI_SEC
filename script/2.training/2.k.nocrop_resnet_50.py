...
from modules.dl.trainer.resnet50nocroptrainer import ResNet50NoCropTrainer
...
resnet50_nocrop_trainer = ResNet50NoCropTrainer()
...
if args.batch_mode == True:
    ...
    for config_path in config_paths:
        resnet50_nocrop_trainer.run(config_path)

else: resnet50_nocrop_trainer.run("2.training.toml")