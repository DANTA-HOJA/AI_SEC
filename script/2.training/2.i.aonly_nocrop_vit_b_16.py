...
from modules.dl.trainer.vitb16aonlynocroptrainer import VitB16AOnlyNoCropTrainer
...
vit_b_16_aonly_nocrop_trainer = VitB16AOnlyNoCropTrainer()
...
if args.batch_mode == True:
    ...
    for config_path in config_paths:
        vit_b_16_aonly_nocrop_trainer.run(config_path)

else: vit_b_16_aonly_nocrop_trainer.run("2.training.toml")