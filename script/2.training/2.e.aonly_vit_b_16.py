...
from modules.dl.trainer.vitb16aonlytrainer import VitB16AOnlyTrainer
...
vit_b_16_aonly_trainer = VitB16AOnlyTrainer()
...
if args.batch_mode == True:
    ...
    for config_path in config_paths:
        vit_b_16_aonly_trainer.run(config_path)

else: vit_b_16_aonly_trainer.run("2.training.toml")