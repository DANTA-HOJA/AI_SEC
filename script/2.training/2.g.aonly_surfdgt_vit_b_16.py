...
from modules.dl.trainer.vitb16aonlysurfdgttrainer import VitB16AOnlySurfDGTTrainer
...
vit_b_16_aonly_surfdgt_trainer = VitB16AOnlySurfDGTTrainer()
...
if args.batch_mode == True:
    ...
    for config_path in config_paths:
        vit_b_16_aonly_surfdgt_trainer.run(config_path)

else: vit_b_16_aonly_surfdgt_trainer.run("2.training.toml")