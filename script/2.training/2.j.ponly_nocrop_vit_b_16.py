...
from modules.dl.trainer.vitb16ponlynocroptrainer import VitB16POnlyNoCropTrainer
...
vit_b_16_ponly_nocrop_trainer = VitB16POnlyNoCropTrainer()
...
if args.batch_mode == True:
    ...
    for config_path in config_paths:
        vit_b_16_ponly_nocrop_trainer.run(config_path)

else: vit_b_16_ponly_nocrop_trainer.run("2.training.toml")