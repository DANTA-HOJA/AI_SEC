...
def dynfilter_trainaug() -> iaa.Sequential:
...
def dynfilter_traintransform(crop_size:int) -> iaa.Sequential:
...
def dynfilter_validtransform(crop_size:int) -> iaa.Sequential:
