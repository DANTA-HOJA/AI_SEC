...
from ..misc.utils import decide_cli_output


def get_fiji_local_path(dbpp_config:Union[dict, TOMLDocument], logger:Logger=None) -> Path:
    """
    """
...
def get_lif_scan_root(dbpp_config:Union[dict, TOMLDocument], 
                      config:Union[dict, TOMLDocument], logger:Logger=None):
    """
    """
    cli_out = decide_cli_output(logger)
