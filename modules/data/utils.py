...
def get_fish_ID_pos(string_with_fish_Dname:str) -> Tuple[int, str]:
    """
    string_with_fish_Dname:
        ...
        # TODO:  use `isinstance()` to identify input is a `Path` or `str`
    """
    
    if os.sep in string_with_fish_Dname: 
    ...
    else: fish_name = string_with_fish_Dname
