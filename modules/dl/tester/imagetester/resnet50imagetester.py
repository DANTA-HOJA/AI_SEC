...
class ResNet50ImageTester(BaseImageTester):
    ...
    def __init__(self, display_on_CLI=True) -> None:
        ...
        self._cli_out._set_logger("ResNet50 Image Tester")
    ...
    def _set_model(self):
        ...
        self.model.fc = nn.Linear(in_features=2048, out_features=len(self.class2num_dict), bias=True)
