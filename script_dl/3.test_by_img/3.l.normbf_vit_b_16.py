...
vit_b_16_normbf_image_tester = VitB16NormBFImageTester()
...
if args.batch_mode == True:
    ...
    for config_path in config_paths:
        vit_b_16_normbf_image_tester.run(config_path)

else: vit_b_16_normbf_image_tester.run("3.test_by_image.toml")